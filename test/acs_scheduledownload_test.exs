...
\t</SOAP-ENV:Body>
  ...
  test "queue ScheduleDownload" do
    # Install a Session Script that send's the ScheduleDownload
    Application.put_env(:acs_ex, :session_script, ACS.Test.Sessions.ScheduleDownload, persistent: false)
  ...
  test "queue ScheduleDownload with bogus parameters" do
    ...
    Application.put_env(:acs_ex, :session_script, ACS.Test.Sessions.ScheduleDownloadBogusParams, persistent: false)

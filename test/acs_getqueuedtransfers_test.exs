...
\t</SOAP-ENV:Body>
  ...
  test "queue GetQueuedTransfers" do
    ...
    # Install a Session Script that send's the GetQueuedTransfers
    Application.put_env(:acs_ex, :session_script, ACS.Test.Sessions.SingleGetQueuedTransfers, persistent: false)

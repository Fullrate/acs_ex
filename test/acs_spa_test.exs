...
\t</SOAP-ENV:Body>
  ...
  test "queue SetParameterAttributes" do
    # Install a Session Script that send's the SetParameterAttributes request
    Application.put_env(:acs_ex, :session_script, ACS.Test.Sessions.SingleSetParameterAttributes, persistent: false)
  ...
  test "queue SetParameterAttributes, bogus params" do
    # Install a Session Script that send's the SetParameterAttributes
    Application.put_env(:acs_ex, :session_script, ACS.Test.Sessions.SingleSetParameterAttributesBogus, persistent: false)

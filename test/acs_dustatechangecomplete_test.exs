defmodule ACSDUStateChangeCompleteTest do
  use ExUnit.Case
  import PathHelpers
  ...
  test "plain DUStateChangeComplete" do
    acsex(ACS.Session.Script.Vendor) do # the no-script
      ...
      {:ok,resp,cookie} = sendFile(fixture_path("acs/dustatechangecomplete1"), cookie)
      assert resp.body == readFixture!(fixture_path("acs/dustatechangecomplete1_response"))
      assert resp.status_code == 200

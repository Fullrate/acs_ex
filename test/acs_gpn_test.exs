...
\t</SOAP-ENV:Body>
  ...
  test "queue GetParameterNames" do
    # Install a Session Script that send's the GetParameterNames request
    Application.put_env(:acs_ex, :session_script, ACS.Test.Sessions.SingleGetParameterNames, persistent: false)
  ...
  test "queue GetParameterNames, bogus params" do
    ...
    Application.put_env(:acs_ex, :session_script, ACS.Test.Sessions.SingleGetParameterNamesBogus, persistent: false)

...
\t</SOAP-ENV:Body>
  ...
  test "queue Download" do
    ...
    Application.put_env(:acs_ex, :session_script, ACS.Test.Sessions.Download, persistent: false)
  ...
  test "queue Download with bogus parameters" do
    # Install a Session Script that send's the GetParameterValues
    Application.put_env(:acs_ex, :session_script, ACS.Test.Sessions.DownloadBogusParams, persistent: false)

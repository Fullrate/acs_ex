defmodule ACSSetParameterValuesTest do
  ...
  @spv_sample_response ~s|<SOAP-ENV:Envelope xmlns:SOAP-ENC="http://schemas.xmlsoap.org/soap/encoding/" xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:cwmp="urn:dslforum-org:cwmp-1-4" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
\t<SOAP-ENV:Header>
...
\t</SOAP-ENV:Body>
  ...
  test "queue SetParameterValues" do
    ...
    ACS.Queue.enqueue("SerialNo1", "SetParameterValues", [%CWMP.Protocol.Messages.ParameterValueStruct{name: "Device.Test", type: "xsd:string", value: "SomeValue"}, %CWMP.Protocol.Messages.ParameterValueStruct{name: "Device.Test2", type: "xsd:int", value: 1}], "TEST")

...
\t</SOAP-ENV:Body>
  ...
  test "queue GetOptions" do
    ...
    Application.put_env(:acs_ex, :session_script, ACS.Test.Sessions.GetOptions, persistent: false)
  ...
  test "queue GetOptions with bogus parameters" do
    ...
    Application.put_env(:acs_ex, :session_script, ACS.Test.Sessions.GetOptionsBogusParams, persistent: false)

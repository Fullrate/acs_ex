...
\t</SOAP-ENV:Body>
  ...
  test "queue Upload" do
    # Install a Session Script that send's the Upload
    Application.put_env(:acs_ex, :session_script, ACS.Test.Sessions.Upload, persistent: false)
  ...
  test "queue Upload with bogus parameters" do
    # Install a Session Script that send's the Upload
    Application.put_env(:acs_ex, :session_script, ACS.Test.Sessions.UploadBogusParams, persistent: false)

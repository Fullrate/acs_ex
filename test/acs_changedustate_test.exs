...
\t</SOAP-ENV:Body>
  ...
  test "queue ChangeDUState" do
    # Install a Session Script that send's the ChangeDUState
    Application.put_env(:acs_ex, :session_script, ACS.Test.Sessions.ChangeDUState, persistent: false)
  ...
  test "queue ChangeDUState with bogus parameters" do
    ...
    Application.put_env(:acs_ex, :session_script, ACS.Test.Sessions.ChangeDUStateBogusParams, persistent: false)
